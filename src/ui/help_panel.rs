...
const KEYBINDINGS: &[(&str, &str)] = &[
    ...
    ("", ""),
    ("Terminal", ""),
    ("t", "Open shell panel in the current directory"),
    ("t (panel open)", "Give the keys back to the shell"),
    ("Ctrl+O", "Leave the shell, back to the file list"),
    ("Shift+T", "Close the shell panel"),
    ("", ""),
    ("Pinned directories", ""),
    ("p", "Open pinned panel"),
